...
public class IParamValueExtractorTest {
    ...
    public void logMessagesWillBeExtracted() {
        ...
        MockRequestParameters params = new MockRequestParameters();
        addMessage(1, params, "error", "message 1", Time.valueOf(new Date(1982, 12, 14, 8, 0)).toRfc1123TimestampString());
        addMessage(2, params, "error", "message 2", Time.valueOf(new Date(1982, 12, 14, 12, 0)).toRfc1123TimestampString());
        addMessage(3, params, "error", "message 3", Time.valueOf(new Date(1982, 12, 14, 16, 0)).toRfc1123TimestampString());
        ...
        assertThat(result.logObjects(), hasItem(new ClientSideLogObject("error", "message 1", Time.valueOf(new Date(1982, 12, 14, 8, 0)).toRfc1123TimestampString(), 1)));
        assertThat(result.logObjects(), hasItem(new ClientSideLogObject("error", "message 2", Time.valueOf(new Date(1982, 12, 14, 12, 0)).toRfc1123TimestampString(), 2)));
        assertThat(result.logObjects(), hasItem(new ClientSideLogObject("error", "message 3", Time.valueOf(new Date(1982, 12, 14, 16, 0)).toRfc1123TimestampString(), 3)));
    }

    private void addMessage(int index, MockRequestParameters params, String level, String message, String utcTimestamp) {
